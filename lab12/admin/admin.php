...
<head>
    ...
    <style>
        ...
        .admin-nav { margin-bottom: 20px; text-align: center; }
        .admin-nav a { margin: 0 10px; font-weight: bold; text-decoration: none; color: #333; }
...
<div class='admin-nav'>
    ...
    <a href='admin.php?akcja=kategorie'>Zarządzanie Kategoriami</a> |
    <a href='admin.php?akcja=produkty'>Zarządzanie Produktami</a> |
    <a href='admin.php?akcja=logout'>Wyloguj</a>
</div>";
...
if (isset($_GET['akcja'])) {
    ...
    switch ($_GET['akcja']) {
        ...
        case "kategorie":
            ZarzadzajKategoriami($link);
            break;

        case "edytuj_kat":
            FormularzEdycjiKategorii($link, $_GET['id']);
            break;

        case "usun_kat":
            echo UsunKategorie($link, $_GET['id']);
            ZarzadzajKategoriami($link);
            break;

        case "produkty":
            ZarzadzajProduktami($link);
            break;
