<?php
    ...
    if($_GET['idp'] == 'buildings') $strona = 'html/buildings.html';
    if($_GET['idp'] == 'contact') $strona = 'html/contact.html';
    if($_GET['idp'] == 'gallery') $strona = 'html/gallery.html';
    if($_GET['idp'] == 'jQuery') $strona = 'html/jQuery.html';
    if($_GET['idp'] == 'rankings') $strona = 'html/rankings.html';
    if($_GET['idp'] == 'films') $strona = 'html/films.html';
